...
class QuickCal_WC {
	...
	protected function filters_and_actions() {
		...
		add_filter('booked_button_book_appointment', array('QuickCal_WC_Functions', 'booked_button_book_appointment'), 10, 1);
		...
		add_action('wp_ajax_booked_new_appointment_form', array('QuickCal_WC_Functions', 'booked_new_appointment_form'), 5);
		add_action('wp_ajax_nopriv_booked_new_appointment_form', array('QuickCal_WC_Functions', 'booked_new_appointment_form'), 5);
		...
		add_action('woocommerce_order_status_cancelled', array('QuickCal_WC_Order_Hooks', 'woocommerce_order_remove_appointment'), 10, 1);
		add_action('woocommerce_order_status_refunded', array('QuickCal_WC_Order_Hooks', 'woocommerce_order_remove_appointment'), 10, 1);
		add_action('woocommerce_order_status_trash', array('QuickCal_WC_Order_Hooks', 'woocommerce_order_remove_appointment'), 10, 1);
		add_action('before_delete_post', array('QuickCal_WC_Order_Hooks', 'woocommerce_order_remove_appointment'), 10, 1);
		...
		add_action('woocommerce_add_order_item_meta', array('QuickCal_WC_Order_Hooks', 'woocommerce_add_order_item_meta'), 10, 4);
