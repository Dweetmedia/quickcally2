...
add_action( 'widgets_init', 'quickcal_register_widgets' );

function quickcal_register_widgets(){
	register_widget( 'QuickCal_Calendar_Widget' );
}

class QuickCal_Calendar_Widget extends WP_Widget {

	public function __construct() {
		$widget_ops = array( 
			'classname' => 'booked_calendar',
			'description' => 'The QuickCal Calendar Widget',
		);
		parent::__construct( 'booked_calendar', esc_html__('QuickCal Calendar','booked'), $widget_ops );
	}
